package com.reuben.weatherforecast.ui.home.weather
...
class HomeRepositoryTests : BaseTest() {
    ...
    private lateinit var homeRepository: com.reuben.feature_weather.ui.HomeRepository
    ...
    override fun setup() {
        super.setup()
        homeRepository = com.reuben.feature_weather.ui.HomeRepository(apiService, UUID.randomUUID().toString(), foreCastDao, locationDao)
    }
