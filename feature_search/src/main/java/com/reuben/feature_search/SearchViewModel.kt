package com.reuben.feature_search
...
import com.reuben.feature_search.data.places.CustomAddressModel
import com.reuben.feature_search.data.places.CustomPlaceDetails
...
class SearchViewModel @Inject constructor(
    ...
    fun getWeatherDataFromLocation(location: Location, locationName: String) {
        viewModelScope.launch {
            ...
            when (val response = withContext(Dispatchers.IO) { locationSearchRepository.getCurrentWeatherByLocation(location) }) {
